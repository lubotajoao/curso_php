<table class="doctable-table">
	...
	<tr>
		<td><em>N</em></td>
		<td>Representação numérica ISO-8601 do dia da semana (adicionado no	PHP 5.1.0)
		</td>
	...
	<tr>
		<td><em>o</em></td>
		<td>Número do ano ISO-8601. Este tem o mesmo valor como	<em>Y</em>, exceto que se o número da semana ISO (<em>W</em>) pertence ao anterior ou próximo ano, o ano é usado ao invés. (adicionado no PHP 5.1.0)
		</td>
	...
	<tr>
		...
		<td>
			...
			<em>000000</em>, já que aceita um parâmetro <span class="type"><a href="language.types.integer.php"
			                                                                  class="type integer">integer</a></span>,
			enquanto que <span class="methodname"><a href="datetime.format.php"
			                                         class="methodname">DateTime::format()</a></span> possui
	...
	<tr>
		<td><em>P</em></td>
		<td>Deslocamento ao Horário de Greenwish (GMT) com dois pontos entre horas e minutos (adicionado no PHP 5.1.3)
		</td>
	...
	<tr>
		...
		<td>Deslocamento, em segundos, do fuso horário. O deslocamento para fusos horários a oeste de UTC sempre será
			negativa, e para aqueles à leste de UTC sempre será positiva.
		</td>
