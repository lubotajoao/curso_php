...
<div class="bottom-index" <?php if ($aula_atual == 'inicio') {
	echo 'style="margin-top: 0"';
} ?> >
	<?php if ($aula_atual != 'inicio') { ?>
		<div class="anterior">
			<a href="<?php echo $anterior_url; ?>">
				<button>&larr; Aula Anterior</button>
			</a>
		</div>
		...
		<?php if ($proxima_url) { ?>
			<div class="proxima">
				...
				<a href="<?php echo $proxima_url; ?>">
					<button>Próxima Aula &rarr;</button>
				</a>
			</div>
		<?php } ?>
