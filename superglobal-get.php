...
<ul>
	...
	foreach ($produtos as $produto => $valor) { ?>
		<li>
			<a href="<?php echo 'superglobal-get.php?item=' . $produto; ?>"><?php echo $valor['nome']; ?></a>
		</li>
	<?php } ?>
</ul>
...
<p>Trabalhe com o array de camisetas. Passe o código do produto via URL, e use a variável $_GET para apresentar o nome
	do produto e os tamanhos disponíveis.</p>
